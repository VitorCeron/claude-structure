...
- Create custom hooks in `src/hooks` for shared logic across components
...
- Separate skeletons from components for better loading states
...
- Code structure adheres to the design principles
